...
class BgScreenWrapper extends StatefulWidget {
  ...
  const BgScreenWrapper({required this.child, required this.background, Key? key}) : super(key: key);
...
class _BgScreenWrapperState extends State<BgScreenWrapper> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: Stack(children: [_background, SafeArea(child: widget.child)]));
  }
}
